...
/**
 * List fragment associated with {@link ResultsActivity} that handles the list of search results. The accompanying view
...
public class ResultsFragment extends ListFragment {
    ...
    /**
     * Interface to facilitate a click listener between the top-level activity {@link MainActivity}
     * and the activities that it calls.
     */
    interface Listener {
        /**
         * Facilitates the List Fragment click listener along the user path from
         * {@link MainActivity}, {@link SearchFragment} to {@link ResultsActivity}, {@link ResultsFragment}
         * to {@link DetailActivity}, {@link DetailFragment}.
